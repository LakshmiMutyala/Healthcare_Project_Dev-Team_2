...
?>
<html>
<div id="caption">HOSPITAL MANAGEMENT SYSTEM<br>Manage Bills</div>
    <head>
            ...
            <div id="caption">
                ...
                <div class="doclist"style="font-weight:bold;display:inline-block;">
                  <?php
                    ...
                    echo "Balance: <b style=\"color:green;font-size:20px\">".$data3['c']." $ USD</b>";
                  ?> 
                ...
                <div class="doclist"style="font-weight:bold;display:inline-block;">
                  <?php
                    ...
                    echo "Due Balance: <b style=\"color:red;font-size:20px\">".$data3['c']." $ USD</b>";
                  ?> 
                ...
                ?>
                 <table align="center">
                    ...
                    <td><?php echo $data2['bill_no'];?></td>
                        ...
                        <td><?php echo $data2['amount']." $ USD"?></td>
